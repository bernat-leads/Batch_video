...
import type { HealthCheckHealthGet200, RootGet200 } from "./model";
...
export const rootGet = (options?: SecondParameter<typeof customInstance>, signal?: AbortSignal) => {
  return customInstance<RootGet200>({ url: `/`, method: "GET", signal }, options);
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof healthCheckHealthGet>>> = ({ signal }) =>
    healthCheckHealthGet(requestOptions, signal);
